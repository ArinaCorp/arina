...
/**
 * SubjectRelation implements the CRUD actions for SubjectRelation model.
 */
class SubjectRelationController extends Controller implements IAdminController
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new SubjectRelationSearch();
    ...
    /**
     * Updates an existing SubjectRelation model.
    ...
    /**
     * Deletes an existing SubjectRelation model.
