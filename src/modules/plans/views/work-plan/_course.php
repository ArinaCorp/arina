...
<div class="table-responsive">
    <table class="table table-bordered">
        <tr>
            <th rowspan="2"></th>
            <th rowspan="2" style="vertical-align: middle"><?= Yii::t('plans', 'Subject'); ?></th>
        ...
        <?php foreach ($model->workSubjects as $subject): ?>
            <?php if ($subject->presentIn($course)): ?>
                <tr>
                    <td>
                        <?= Html::a(Yii::t('app', 'Update'), ['update-subject', 'id' => $subject->id]); ?>
                        <?= Html::a(Yii::t('app', 'Delete'), ['work-plan/delete-subject', 'id' => $subject->id]); ?>
                    </td>
                    <td>
                    ...
                    <td>
                        <?= $subject->cyclicCommission->short_title; ?>
                    </td>
                </tr>
            <?php endif; ?>
        <?php endforeach; ?>
