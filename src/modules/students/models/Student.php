...
class Student extends \yii\db\ActiveRecord
{
    ...
    {
        return parent::find()->orderBy(['last_name' => SORT_ASC, 'first_name' => SORT_ASC, 'middle_name' => SORT_ASC]); // TODO: Change the autogenerated stub
    }
    ...
    public function validate($attributeNames = null, $clearErrors = true)
    {
        ...
        if (!empty($this->has_phones)) {
            $phonesValidation = StudentsPhone::validateSt($this);
            if (!$phonesValidation) {
                $success = false;
            }
        }
        if (!empty($this->has_emails)) {
