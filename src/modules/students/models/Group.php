...
class Group extends ActiveRecord
{
    ...
    {
        return [
            [['speciality_qualifications_id', 'created_study_year_id', 'number_group', 'group_leader_id', 'curator_id'], 'integer'],
            [['title'], 'string', 'max' => 8],
        ];
    }
    ...
    {
        return $this->hasOne(Employee::class, ['id' => 'curator_id']); // TODO: Change the autogenerated stub
    }
    ...
    {
        return $this->hasOne(SpecialityQualification::class, ['id' => 'speciality_qualifications_id']);
    }
    ...
    {
        return $this->hasOne(Student::class, ['id' => 'group_leader_id']);
    }
