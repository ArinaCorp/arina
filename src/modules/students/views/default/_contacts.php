            ...
            <?php foreach ($modelsSocials as $index => $modelSocial): ?>
                <div class="item panel panel-default"><!-- widgetBody -->
                    ...
                    <div class="panel-body">
                        ...
                        ?>
                        <div class="col-xs-12">
                            <?= $form->field($modelSocial, "[{$index}]network_id")->dropDownList(\app\modules\students\models\SocialNetwork::getList(), ['prompt' => Yii::t('app', 'Select') . ' ' . Yii::t('app', 'Social network')]); ?>
                        </div>
                        <div class="col-xs-12">
